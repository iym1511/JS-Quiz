...
const Quiz90 = () => {
  ...
  const randomItem = (a) => {
    ...
    let medicine = string.join(""); // 배열 모든요소 문자열로
    return medicine;
  };
